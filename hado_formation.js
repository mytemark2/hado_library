...
function resetFormationListPanelScroll(){const panel=els.formationRoot?.querySelector?.('.formation-list-panel');if(panel){panel.scrollTop=0;if(typeof panel.scrollTo==='function')panel.scrollTo({top:0,left:0,behavior:'auto'});debugLog('formationListPanel:scroll-reset',{scrollTop:panel.scrollTop});}}
