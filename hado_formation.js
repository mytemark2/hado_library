...
function resetFormationListPanelScroll(){const panel=els.formationRoot?.querySelector?.('.formation-list-panel');if(panel){panel.scrollTop=0;debugLog('formationListPanel:scroll-reset',{scrollTop:panel.scrollTop});}}
