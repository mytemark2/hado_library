...
- 現在の到達点: `3.1.0.0 r197`。状態変化・確認済みClause・生成Clauseの索引を武将レコード完全名で分離し、LR・UR・通常版・ORIGINS版の間で状態変化や条件が混入しないようにしています。全2,920状態変化対象エンティティ、5,342関連、1,822 Clauseエンティティを自動監査します。
