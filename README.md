...
- 正式版: `3.1.0.0`
- 正式版正本ブランチ: `main`
- 現在の開発ブランチ: `feature/app-3.1.2.0`
- 開発Preview: `3.1.2.0 r208`（兵科技能検索、カテゴリ順・詳細リンク境界の調整、Clause Shadowの利用者画面からの除外）
- 3.1.0.0は正式公開済みです。3.1.1.0のコピー／共有機能を継承し、3.1.2.0をPreview確認します。
- 配布用ZIPは当面公開しません。
