...
- 正式版: `3.1.2.0`
- 正式版正本ブランチ: `main`
- 完了した開発ブランチ: `feature/app-3.1.2.0`
- 検証済みPreview: `3.1.2.0 r208`（兵科技能検索、カテゴリ順・詳細リンク境界の調整、Clause Shadowの利用者画面からの除外）
- 3.1.1.0のコピー／共有機能を継承した3.1.2.0を正式公開しています。revision `208`は追跡用に保持し、正式版画面には表示しません。
- 配布用ZIPは当面公開しません。
...
- 3.1.2.0開発ブランチは、3.1.1.0実装に最新`main`の確定JSONデータを統合して作成しています。
