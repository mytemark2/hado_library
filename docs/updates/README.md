...
現在の到達点: `3.0.1.0 Update11.3 r163`（公開Preview反映済み、スマホ実機受入待ち）
...
| Update11 | Preview反映済み（最新: 11.3 r163、スマホ実機受入待ち） | タグカテゴリ表示・状態変化検索タグ対応・技能所有者タグ修正・タグ自動追加・スマホ表示改善 | [roadmap](update11/roadmap.md) | [implementation](update11/implementation.md) | [report](update11/report.md) |
