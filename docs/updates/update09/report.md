...
- Minimum acceptance: on smartphone width, open 部隊編成 and confirm the visible order is トータルスコア -> 結果サマリー -> 軍馬, then tap トータルスコア to expand/collapse the itemized evaluation scores.
