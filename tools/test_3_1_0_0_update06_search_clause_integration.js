...
assert(indexHtml.includes('hado_search_clause_integration.js?v=3.1.2.0-r207'));
assert(!indexHtml.includes('06-r180'));
assert(!indexHtml.includes('07-r179'));
assert(versionSource.includes("updateNo: ''"));
assert(versionSource.includes('revision: 207'));
...
assert.strictEqual(context.window.HADO_APP_DISPLAY_VERSION, '3.1.2.0 r207');
