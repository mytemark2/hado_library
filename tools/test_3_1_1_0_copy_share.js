...
(async () => {
  ...
  assert(indexHtml.includes('hado_share.js?v=3.1.2.0-r206'));
  assert(indexHtml.includes('hado_share.css?v=3.1.2.0-r206'));
  assert(indexHtml.includes('hado_styles.css?v=3.1.2.0-r206'));
