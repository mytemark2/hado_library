...
def main() -> int:
    ...
    if "updateNo: '09.4.21'" in version_js:
        ...
        if "updateNo: '09.5.9'" in version_js:
            require(version_js, "revision: 103", "Update09.5.9 revision after completed Phase 4")
            require(version_js, "Update09.5.9", "visible Phase 5 version summary")
    ...
    for needle in [
        ...
        "候補トレイ",
        "部隊編成",
        "./hado_styles.css?v=09.5.9",
        "./hado_formation.js?v=09.5.9",
        "全データ表示",
        "保存データ表示",
        "グループ選択欄",
        "変更",
