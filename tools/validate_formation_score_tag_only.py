...
REQUIRED = (
    ...
    "data-formation-score-detail-open",
    "クリックで詳細表示",
    "function uniqueFormationScoreEvidenceSummaryRows(evidenceRows)",
    "function formationScoreEvidenceSimpleTitle(item)",
    ...
    "formation-score-evidence-line-item",
    "formation-score-evidence-line-main",
    "formation-score-evidence-effect formation-score-evidence-label",
    "対象: ${esc(item.targetScopeLabel||'対象不明')}",
    "根拠: ${esc(item.source||'スコア根拠')}",
    "formation-score-evidence-line-raw",
    "formation-score-evidence-raw-label",
    "kindLabel:(item?.kindLabel&&item.kindLabel!=='型要素'?item.kindLabel:'標準効果')",
    "changeItemDisplayLabel:item?.changeItemDisplayLabel||item?.label||''",
    ...
    "formationScore:detail-open-delegate",
...
CSS_REQUIRED = (
    ...
    ".formation-score-evidence-dialog-list{display:flex!important;flex-direction:column!important",
    ...
    ".formation-score-evidence-line-item{width:100%;display:block",
    ".formation-score-evidence-line-main{display:flex",
    ".formation-score-evidence-line-raw{display:flex",
