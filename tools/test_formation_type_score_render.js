...
assert(html.includes('formation-score-chip-detail'), 'evaluation score chips must be clickable details');
assert(html.includes('検証支援技能') || html.includes('検証回復技能'), 'score detail HTML must include matched evidence labels');
