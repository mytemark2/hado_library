...
assert(indexHtml.indexOf('hado_search_clause_integration.js?v=3.1.0.0-r192') < indexHtml.indexOf('hado_clause_surface_bridge.js?v=3.1.0.0-r192'));
assert(indexHtml.indexOf('hado_clause_surface_bridge.js?v=3.1.0.0-r192') < indexHtml.indexOf('hado_formation.js?v=3.1.0.0-r192-mobile-parity'));
assert(indexHtml.includes('hado_update08.css?v=3.1.0.0-r192'));
assert(!indexHtml.includes('06-r187'));
assert(versionSource.includes("updateNo: ''"));
assert(versionSource.includes('revision: 192'));
