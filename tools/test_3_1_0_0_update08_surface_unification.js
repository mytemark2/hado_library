...
assert(indexHtml.indexOf('hado_search_clause_integration.js?v=3.1.0.0-r202') < indexHtml.indexOf('hado_clause_surface_bridge.js?v=3.1.0.0-r202'));
assert(indexHtml.indexOf('hado_clause_surface_bridge.js?v=3.1.0.0-r202') < indexHtml.indexOf('hado_formation.js?v=3.1.0.0-r202-mobile-parity'));
assert(indexHtml.includes('hado_update08.css?v=3.1.0.0-r202'));
