...
assert(indexHtml.indexOf('hado_search_clause_integration.js?v=08-r189') < indexHtml.indexOf('hado_clause_surface_bridge.js?v=08-r189'));
assert(indexHtml.indexOf('hado_clause_surface_bridge.js?v=08-r189') < indexHtml.indexOf('hado_formation.js?v=08-r189-mobile-parity'));
assert(indexHtml.includes('hado_update08.css?v=08-r189'));
assert(!indexHtml.includes('06-r187'));
assert(versionSource.includes("updateNo: '08'"));
assert(versionSource.includes('revision: 189'));
