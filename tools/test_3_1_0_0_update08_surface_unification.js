...
assert(indexHtml.indexOf('hado_search_clause_integration.js?v=08-r188') < indexHtml.indexOf('hado_clause_surface_bridge.js?v=08-r188'));
assert(indexHtml.indexOf('hado_clause_surface_bridge.js?v=08-r188') < indexHtml.indexOf('hado_formation.js?v=08-r188-mobile-parity'));
assert(indexHtml.includes('hado_update08.css?v=08-r188'));
assert(!indexHtml.includes('06-r187'));
assert(versionSource.includes("updateNo: '08'"));
assert(versionSource.includes('revision: 188'));
