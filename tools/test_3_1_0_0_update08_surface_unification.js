...
assert(indexHtml.indexOf('hado_search_clause_integration.js?v=3.1.1.0-r205') < indexHtml.indexOf('hado_clause_surface_bridge.js?v=3.1.1.0-r205'));
assert(indexHtml.indexOf('hado_clause_surface_bridge.js?v=3.1.1.0-r205') < indexHtml.indexOf('hado_formation.js?v=3.1.1.0-r205'));
assert(indexHtml.includes('hado_update08.css?v=3.1.1.0-r205'));
