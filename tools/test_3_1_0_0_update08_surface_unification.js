...
assert(indexHtml.indexOf('hado_search_clause_integration.js?v=3.1.0.0-r190') < indexHtml.indexOf('hado_clause_surface_bridge.js?v=3.1.0.0-r190'));
assert(indexHtml.indexOf('hado_clause_surface_bridge.js?v=3.1.0.0-r190') < indexHtml.indexOf('hado_formation.js?v=3.1.0.0-r190-mobile-parity'));
assert(indexHtml.includes('hado_update08.css?v=3.1.0.0-r190'));
assert(!indexHtml.includes('06-r187'));
assert(versionSource.includes("updateNo: ''"));
assert(versionSource.includes('revision: 190'));
