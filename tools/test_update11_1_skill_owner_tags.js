...
assert(version.includes('revision: 161'), 'revision must be r161');
...
assert(html.includes('hado_status_effects.js?v=11.1-r161-skill-owner-tags'), 'changed runtime must use the Update11.1 cache key');
