...
const nonDamageBulkEntity={roleId:'formation_effects',typeFeatures:[
  {featureId:'skill_effect:ally_non_damage_effect',label:'知力',matchedText:'自部隊の知力を上昇',sourceLabel:'技能A'},
  {featureId:'skill_effect:ally_non_damage_effect',label:'攻撃',matchedText:'自部隊の攻撃を上昇',sourceLabel:'技能B'},
  {featureId:'skill_effect:ally_non_damage_effect',label:'戦法威力',matchedText:'自部隊の戦法威力を上昇',sourceLabel:'技能C'},
  {featureId:'skill_effect:ally_non_damage_effect',label:'会心発生',matchedText:'自部隊の会心発生を上昇',sourceLabel:'技能D'},
  {featureId:'skill_effect:ally_non_damage_effect',label:'攻撃速度',matchedText:'自部隊の攻撃速度を上昇',sourceLabel:'技能E'},
